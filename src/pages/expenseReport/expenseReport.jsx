...
export default function ExpenseReport() {
 ...
 <div className={styles.expenseReportContainer}>
  ...
  <h2>Objectif : Visualiser et anticiper les rentrées financières par semaine ou mois, par commande.</h2>

  <ul>
    <li>🧠 Peut-on établir un **plan de facturation automatique** par commande (modulable manuellement ensuite) ?</li>
    <li>🔀 Le **plan de facturation diffère-t-il** entre une mission de distribution et de gestion de projet ?</li>
    <li>📅 Quelles **données extraire** pour piloter : hebdo / mensuel / global ?</li>
    <li>🕐 Comment gérer la **modification des dates de facturation** initialement fixées ?</li>
    <li>📤 Export : sous quel format ? Tableau ? PDF ? Lien Google Sheets privé ?</li>
    {/* <li>🤖 Intégrer une IA (Gemini, GPT) pour interpréter les flux et suggérer des actions ?</li> */}
  </ul>
</div>
